...
/**
 * Servlet implementation class DeleteBillpaymentServlet
 */
@WebServlet("/DeleteBillpaymentServlet")
public class DeleteBillpaymentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteBillpaymentServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		iBillpaymentService.removeBillpayment(billID);
